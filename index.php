          ...
          <div class="carousel-item active" style="background-image: url(assets/img/intro-carousel/6.jpg)">
            <div class="carousel-container">
              <div class="container-fluid text-center">
                ...
                <a href="#featured-services" class="btn-get-started scrollto animate__animated animate__fadeInUp mt-5">Хочу</a>
              </div><!-- /.container -->
           ...
           <div class="carousel-item" style="background-image: url(assets/img/intro-carousel/7.png)">
            <div class="carousel-container">
              <div class="container-fluid text-center">
                ...
                <a href="/reality.php" class="btn-get-started scrollto animate__animated animate__fadeInUp mt-5">Хочу</a>
              </div><!-- /.container -->
            </div> <!-- /.carousel-container -->
          </div> <!-- ./carousel-item -->
