...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 27 2020 г., 20:12
...
(32, 1, 'HTC Vive', 'Хочу такое на праздник', 'Игры', '4', 'Ваша локация', '1', '1', '1', '1', '1', 'Принят', 3, '2020-09-27 00:11:16', ''),
...
CREATE TABLE `users` (
  ...
  `admin_param` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'qwerty', '555', 'q@werty.ru', 'd8578edf8458ce06fbc5bb76a58c5ca4', 'LuuW8I5tDqRJ6223eZim', 1, 'Анатолий', 'Дмитриев', 'Admin');
